...
public class Gradedetails extends JFrame implements ActionListener{
    ...
    public void gradesheet() {
        try {
            ...
            String sql = "select student_id,name,JAVA,dsp,itc,math,datastr,embedded,coa,(JAVA+dsp+itc+math+datastr+embedded+coa) as 'Obtain Marks',((JAVA+dsp+itc+math+datastr+embedded+coa)*100/700) as 'Percentage Obtained' from gradesheet";
    ...
    public Gradedetails() {
        ...
        b1.setBorder(new LineBorder(new Color(255, 20, 14), 2, true));
        ...
        JLabel l1 = new JLabel("Student Marks Details");
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/back.png"));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Student-Grade-Details",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            Connect conn = new Connect();
            if( ae.getSource() == b1){
                String sql = "select * from gradesheet where concat(name, student_id) like ?";
            ...
            if(ae.getSource() == b2){
                String sql = "delete from gradesheet where name = '" + search.getText() + " ";
                PreparedStatement st = conn.con.prepareStatement(sql);
