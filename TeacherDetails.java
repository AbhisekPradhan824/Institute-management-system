...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    public TeacherDetails() {
        ...
        JLabel l1 = new JLabel("Teacher Details");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Teacher-Details",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String sql = "select * from teacher where concat(teacher_id, teacher_name) like ?";
                PreparedStatement st = conn.con.prepareStatement(sql);
            ...
            if(ae.getSource() == b2){
                String sql = "delete from teacher where teacher_name = '" + search.getText() + "'";
